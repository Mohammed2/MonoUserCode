...
public:
  ...
  virtual inline void readCalib(const std::string &fileName,MIJType *calibMap) {
    assert(calibMap);
    calibMap->clear();
  ...
  virtual inline void dumpCalib(const std::string &fileName,const MIJType &calibMap) const {
